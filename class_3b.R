...
# 7. Remove corrupted CEL files (VERY IMPORTANT)
...
# 10. Normalize using RMA
norm_data <- rma(raw_data)

# 11. Extract normalized expression matrix
expression_data <- exprs(norm_data)

# 12. QC – Density plot after normalization
...
# 14. Filter low-expression probes
...
# 16. Save filtered expression matrix
write.csv(filtered_data,
          "Results/filtered_expression_data.csv")

# 17. Histogram of row medians
...
# 18. Count total, disease, normal samples
